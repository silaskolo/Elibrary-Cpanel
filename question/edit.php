...
if (!isset($_GET['questionID']))
    redirect_to(APP_ROOT . "/question/index.php");

$questionID = $connection->real_escape_string(trim($_GET['questionID']));

$question_query = sprintf("SELECT * FROM app_past_questions WHERE questionID='%s'", $questionID);
...
if (isset($_POST['action']) && $_POST['action'] == 'editQuestion') {
    ...
    if ($has_error) {
        ...
        $updated_rows = update_query($connection, "app_past_questions", $args, [
            "questionID" => $question['questionID']
        ]);

        if ($updated_rows || !empty($file)) {
            ...
            if (!empty($file)) {
                $file_response = upload_files(
                    [
                        "filename" => $question['questionID'] . "_file",
    ...
    <div class="row mt-5">
        <div class="col form-portlet">
            ...
            <form method="post" action="#" enctype="multipart/form-data">
                    ...
                    <select
                        ...
                        <?php while ($course = $course_result->fetch_assoc()) {
                            ...
                            <option
                                ...
                                <?php echo $question['courseID'] == $course['courseID'] ? "selected" : "" ?>
                    ...
                    <select
                        ...
                        <?php while ($type = $type_result->fetch_assoc()) {
                            ...
                            <option
                                ...
                                <?php echo $question['typeID'] == $type['typeID'] ? "selected" : "" ?>
                    ...
                    <select
                        ...
                        <?php while ($semester = $semester_result->fetch_assoc()) {
                            ...
                            <option
                                ...
                                <?php echo $question['semesterID'] == $semester['semesterID'] ? "selected" : "" ?>
                ...
                <div class="form-group">
                    ...
                    <select
                        ...
                        <?php foreach ($years as $year) { ?>
                            <option
                                    value="<?php echo $year; ?>"
                                <?php echo $question['questionYear'] == $year ? "selected" : "" ?>
                ...
                <button class="btn btn-danger" type="submit">Update Question</button>
